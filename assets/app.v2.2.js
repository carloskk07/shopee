(() => {
  ...
  function track(name,params={}){
    if(consent.analytics&&typeof window.gtag==="function")window.gtag("event",name,params);
    if(consent.marketing&&window.ttq?.track)try{window.ttq.track(name,params)}catch(_){}
  }
